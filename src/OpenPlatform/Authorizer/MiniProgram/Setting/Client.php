...
class Client extends BaseClient
{
    ...
    public function addCategory(
        ...
        $certs = array_map(function ($key, $value) {
            return ['key' => $key, 'value' => $value];
        }, array_keys($certicates), $certicates);
    ...
    public function modifyCategory(
        ...
        return $this->httpPostJson('cgi-bin/wxopen/modifycategory', $params);
    }
